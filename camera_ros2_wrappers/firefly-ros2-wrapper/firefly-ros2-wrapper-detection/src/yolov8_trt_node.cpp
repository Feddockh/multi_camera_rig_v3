...
#include "firefly_detection/qos_utils.hpp"
...
public:
    Yolov8TrtNode() : Node("yolov8_trt_node")
    {
        ...
        // QoS profiles
        auto sub_qos = firefly_detection::makeQos(sub_rel_, sub_dur_, sub_hist_, sub_depth_);
        auto pub_qos = firefly_detection::makeQos(pub_rel_, pub_dur_, pub_hist_, pub_depth_);
